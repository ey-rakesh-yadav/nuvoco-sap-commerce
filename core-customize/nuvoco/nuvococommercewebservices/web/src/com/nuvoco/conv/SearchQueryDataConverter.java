...
public class SearchQueryDataConverter extends AbstractRedirectableConverter
{
	...
	{
		final SearchQueryData searchQueryData = getSolrSearchQueryEncoder().convert((SolrSearchQueryData) source);
		Objects.requireNonNull(searchQueryData, "Converted Search Query Data cannot be null");
		writer.setValue(searchQueryData.getValue());
	}
