 ...
 */
package com.nuvoco.v1.controller;
...
import com.nuvoco.exceptions.InvalidPaymentInfoException;
import com.nuvoco.exceptions.NoCheckoutCartException;
import com.nuvoco.exceptions.UnsupportedDeliveryAddressException;
import com.nuvoco.exceptions.UnsupportedDeliveryModeException;
import de.hybris.platform.commercefacades.order.data.CartModificationDataList;
import com.nuvoco.populator.HttpRequestPaymentInfoPopulator;
import com.nuvoco.populator.options.PaymentInfoOption;
import com.nuvoco.stock.CommerceStockFacade;
import com.nuvoco.validator.CCPaymentInfoValidator;
import com.nuvoco.validator.PlaceOrderCartValidator;
...
public class CartController extends BaseController
{
	...
	public CartModificationData pickupEntryInStore(@PathVariable final String baseSiteId, @PathVariable final long entryNumber,
			...
			throws CommerceCartModificationException, LowStockException, StockSystemException, WebserviceValidationException
	{
		if (LOG.isDebugEnabled())
		{
