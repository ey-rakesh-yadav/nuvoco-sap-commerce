...
import com.nuvoco.populator.HttpRequestAddressDataPopulator;
import com.nuvoco.populator.HttpRequestCustomerDataPopulator;
import com.nuvoco.populator.HttpRequestPaymentInfoPopulator;
import com.nuvoco.populator.options.PaymentInfoOption;
import com.nuvoco.user.data.AddressDataList;
import com.nuvoco.user.data.LoginChangeResponse;
import com.nuvoco.user.data.PasswordRestoreResponse;
import com.nuvoco.validation.data.AddressValidationData;
...
public class CustomersController extends BaseController
{
	...
	public void convertAnonymousUserToCustomer(@RequestParam final String password, final HttpSession httpSession)
			throws DuplicateUidException, SessionAttributeException
	{
	...
	public AddressData createAddress(final HttpServletRequest request) 
			throws DuplicateUidException, WebserviceValidationException
	{
