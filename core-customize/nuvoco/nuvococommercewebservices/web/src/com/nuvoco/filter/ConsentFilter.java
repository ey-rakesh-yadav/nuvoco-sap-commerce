...
public class ConsentFilter extends OncePerRequestFilter
{
	...
	private boolean populatingConsentsEnabled;
	...
	void handleConsents(final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		if (getUserFacade().isAnonymousUser())
		{
			...
			getAnonymousConsentFacade().setPopulatingConsentsEnabled(isPopulatingConsentsEnabled());
		}
		else
		{
	...
	{
		return populatingConsentsEnabled;
	}

	@Required
	public void setPopulatingConsentsEnabled(final boolean populatingConsentsEnabled)
	{
		this.populatingConsentsEnabled = populatingConsentsEnabled;
	}
}
