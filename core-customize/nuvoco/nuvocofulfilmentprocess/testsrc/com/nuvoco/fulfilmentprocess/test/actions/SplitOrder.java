 ...
 */
package com.nuvoco.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NuvocoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NuvocoFulfilmentProcessConstants.PARENT_PROCESS);
