...
import com.nuvoco.test.constants.NuvocoTestConstants;
import com.nuvoco.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NuvocoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nuvocotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nuvocotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/nuvocotest/import/cstickets.impex");
			...
			importImpexFile(context, "/nuvocotest/import/csquotes.impex");
		}
	}
}
